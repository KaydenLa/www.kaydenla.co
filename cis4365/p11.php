...
$sql = 'SELECT BUDGET.BUDGET_ID, BUDGET.AMOUNT as BUDGET_ALLLOTED, BUDGET.START_WEEK AS BUDGET_WEEK, EXPENSE.EXPENSE_AMOUNT AS EXPENSES_INCURRED, BUDGET.AMOUNT-EXPENSE.EXPENSE_AMOUNT AS BUDGET_VS_INCURRED FROM BUDGET RIGHT JOIN INGREDIENT_INVENTORY ON INGREDIENT_INVENTORY.BUDGET_ID = BUDGET.BUDGET_ID right JOIN EXPENSE on EXPENSE.EXPENSE_ID = INGREDIENT_INVENTORY.EXPENSE_ID;';
...
echo '<p style="color:red">','Problem 11' ,'</p>';
echo '<p>Comparison of budget expenses vs incurred expenses.</p>';
