...
$sql = 'SELECT E.EVENT_DESCRIPTION AS Event_Type, SUM(O.TOTAL_COST) AS Total_Revenue FROM EVENT E JOIN CATERING C ON E.EVENT_ID = C.EVENT_ID JOIN INVOICE I ON C.CATERING_ID = I.CATERING_ID JOIN `ORDER` O ON I.ORDER_ID = O.ORDER_ID GROUP BY E.EVENT_DESCRIPTION ORDER BY Total_Revenue DESC;';
...
echo '<p style="color:red">','Problem 7' ,'</p>';
echo '<p>.</p>';
